...
rm -rf package/small-package/{base-files,docker,dockerd,haproxy,transmission,dnsmasq,firewall*,fullconenat,libnftnl,nftables,ppp,opkg,ucl,upx,vsftpd*,miniupnpd-iptables,wireless-regdb,natflow,luci-app-bandwidthd,luci-app-bypass,luci-app-dogcom}
